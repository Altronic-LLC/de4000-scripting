...
local Ratio_Answer = map(get_channel_val(1,1),450,950,0,100) -- This example "Temperature" = Name, get_channel_val(1,1) = Input, 450 = input_Minimum, 950 = input_Maximum, 0 = Output_Minimum, 100 = Output_Maximum
