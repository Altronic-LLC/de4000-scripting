  -- Linear Auto / Manual Control 
function AO_Linear_ManAuto(Name,Linear_Number,Increment,Enable_Manual)
    ...
    if get_sVirt(Name.."_Mode") == "Manual" then 
      set_sGbl("LINEAR"..Linear_Number.."Override",get_sVirt(Name.."_Manual_POS") )
    else
      set_sGbl("LINEAR"..Linear_Number.."Override",-1)
      set_sVirt(Name.."_Manual_POS",math.floor(get_sVirt("LINEAR"..Linear_Number.."Op",0)))
    end
